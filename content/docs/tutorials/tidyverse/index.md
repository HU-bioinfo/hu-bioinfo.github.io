...
この原則における変数とは，データの特徴を表すものです．人を対象にしたデータだとすると身長や体重，年齢などが該当します．
...
初めに手続きプログラミング的にコードを書いてみます．以下のコードは，データフレームdfを宣言し，value列の値が20より大きいものを選択し，groupごとに集計し，平均値を算出したものを出力するコードです．
```R
library(dplyr)
